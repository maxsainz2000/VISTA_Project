...
- **Status:** in-progress
- **Root cause:** Immediate Window blocked by VS hot-reload conflict with `#If DEBUG` source files (same as POS-13 Test 2).
- **Fix description:** Dev menu button — same pattern as all prior harnesses.
- **Final commit:** TBD
