...
CREATE TABLE IF NOT EXISTS `Acc_VatReturns` (
    ...
    `TotalVatableSales` DECIMAL(18, 2) NOT NULL,
    `TotalVatExemptSales` DECIMAL(18, 2) NOT NULL,
    `TotalZeroRatedSales` DECIMAL(18, 2) NOT NULL,
    `TotalOutputVat` DECIMAL(18, 2) NOT NULL,
    `TotalVatablePurchases` DECIMAL(18, 2) NOT NULL,
    `TotalInputVat` DECIMAL(18, 2) NOT NULL,
    `VatPayable` DECIMAL(18, 2) NOT NULL,
    `FilingStatus` INT NOT NULL,
    `FiledAt` DATETIME(6) NULL,
    `FiledBy` VARCHAR(256) NULL,
    ...
    `RowVersion` TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
    PRIMARY KEY (`Id`),
    UNIQUE KEY `IX_Acc_VatReturns_Year_Period_PeriodType_FormType` (`Year`, `Period`, `PeriodType`, `FormType`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `Acc_VatReturnLines` (
    ...
    `TransactionDate` DATETIME(6) NOT NULL,
    `VatableAmount` DECIMAL(18, 2) NOT NULL,
    `VatExemptAmount` DECIMAL(18, 2) NOT NULL,
    `ZeroRatedAmount` DECIMAL(18, 2) NOT NULL,
    `OutputVat` DECIMAL(18, 2) NOT NULL,
