...
| [readonly-client-blocked-by-startup-ddl-bootstrap](errors/readonly-client-blocked-by-startup-ddl-bootstrap.md) | error-fix | MerchSys.App | mariadb, schema-bootstrap, ddl, grants, least-privilege, read-only, tailscale, startup, runtime-error | claude-code | 2026-06-02 | diagnosed (remediation deferred) |
