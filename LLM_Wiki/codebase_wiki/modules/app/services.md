...
| `src/MerchSys.App/Services/DefaultNotificationService.vb` | `INotificationService`<br>`DefaultNotificationService` | Singleton that surfaces user-facing toast notifications (success, error, information, warning) to the UI shell. |
