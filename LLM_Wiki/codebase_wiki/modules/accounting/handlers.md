...
|---|---|---|---|
| `src/MerchSys.Accounting/Handlers/SaleCompletedAccountingHandler.vb` | `SaleCompletedAccountingHandler` | `SaleCompletedEvent` | Records per-item revenue and calculates initial COGS/Gross Profit. |
